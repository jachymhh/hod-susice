...
> **Hackathon Otevřených Dat, Sušice** | Tým **VOŠ a SPŠE Plzeň**

Cílem projektu je **automatizace komunikace** Půlmaratonu Plzeňského kraje pomocí umělé inteligence, čímž ulehčujeme práci organizátorům a zlepšujeme servis pro účastníky.

---

## ✨ Klíčové Funkce

* **AI Chatbot (Gemini):** Okamžité odpovídání na dotazy k závodu (trasa, registrace, FAQ) s využitím otevřených dat jako znalostní báze.
...
| **Data** | **Otevřená Data (Plzeňský kraj)** | Znalostní báze pro AI (trasy, propozice, kontakty). |
...
4.  **Akce:** N8N odešle odpověď zpět uživateli (SMTP pro email / API pro chat).
